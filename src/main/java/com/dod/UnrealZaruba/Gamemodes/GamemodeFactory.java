...
public class GamemodeFactory {
    ...
    public static void Initialize(GameStatisticsService gameStatisticsService, IGameTimer gameTimer) {
        gamemodes.put(DestroyObjectivesGamemode.GAMEMODE_NAME, () -> new DestroyObjectivesGamemode(gameStatisticsService, gameTimer));
        gamemodes.put(ShipsGamemode.GAMEMODE_NAME, () -> new ShipsGamemode(gameStatisticsService, gameTimer));
    }
